...
<body style="
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td bgcolor="slateblue" align="center" style="padding: 0px 10px 0px 10px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="center" style="
                                ...
                                ">
                            <p style="margin: 0">
                                Enjoy sharing snaps with your mates
                            </p>
                        </td>
                    </tr>
                    <!-- COPY -->
                    <tr>
                        <td bgcolor="#ffffff" align="center" style="
                            ...
                            <p style="
                                    ...
                                    ">
                                Contact us:
                                <a href="mailto:snapShareLtd@gmail.com" target="_blank" style="color: slateblue">snapShareLtd@gmail.com</a>
                            </p>
                        </td>
                    </tr>
                </table>
